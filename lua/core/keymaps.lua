...
vim.keymap.set('n', '<leader>b', '<cmd> enew <CR>', opts('New [B]uffer')) -- new buffer
...
-- Window management
vim.keymap.set('n', '<leader>v', '<C-w>v', opts('Split [V]ertically'))      -- split window vertically
vim.keymap.set('n', '<leader>h', '<C-w>s', opts('Split [H]orizontally'))      -- split window horizontally
vim.keymap.set('n', '<leader>se', '<C-w>=', opts('[S]plit [E]qually'))     -- make split windows equal width & height
