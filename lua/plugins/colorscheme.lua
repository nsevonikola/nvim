return {
	...
	config = function()
		...
		vim.api.nvim_set_hl(0, "NeoTreeDirectoryName", { fg = "#c7b199" }) -- Directory names
		vim.api.nvim_set_hl(0, "NeoTreeDirectoryIcon", { fg = "#f0a44d" }) -- Directory icons
		vim.api.nvim_set_hl(0, "NeoTreeFileName", { fg = "#d4d1be" }) -- File names
		vim.api.nvim_set_hl(0, "NeoTreeFileIcon", { fg = "#d4d1be" }) -- File icons
